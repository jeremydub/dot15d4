...
mod tests {
    ...
    use super::CSMA_CA_TX_GUARD_TIME;
        ...
        tester.assert_transition(
            ...
            TaskTestTransition::DrvReqTx(&|task_tx, _result| {
                let expected_timestamp = context
                    ...
                    .timer
                    .now()
                    .checked_add_duration(CSMA_CA_TX_GUARD_TIME)
                    .unwrap()
